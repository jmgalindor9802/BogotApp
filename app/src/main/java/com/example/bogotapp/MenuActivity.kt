    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.recycler.adapter=SitiosAdapter(
            listOf(
                ...
                Sitio("Museo Nacional","museo_nal","El Museo Nacional de Colombia, comúnmente abreviado como Museo Nacional o MNC, es el primer museo fundado en la República de Colombia. Cuenta con su sede en la capital, Bogotá. Fue fundado por ley del congreso constitucional de la Gran Colombia el 28 de julio de 1823, durante el primer mandato del gobierno encabezado por el presidente Simón Bolívar y el vicepresidente Francisco de Paula Santander. Sin embargo, inició su funcionamiento el 4 de julio del mismo año, cuando se declaró oficialmente creado. Esto lo convierte en la primera institución museal de Colombia y una de las más antiguas de América.")
            )
        )
    }
}